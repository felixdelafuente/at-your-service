...
public class ExploreMenuClient extends AppCompatActivity {
    GridView gridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explore_menu_client);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position ==  0) {
                    startActivity(new Intent(ExploreMenuClient.this, ExploreClientRecruit.class));
                }
                if (position ==  1) {
                    startActivity(new Intent(ExploreMenuClient.this, ExploreClientRecruit.class));
                }
        ...
        navExplore.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(ExploreMenuClient.this, ExploreMenuClient.class));
            }
        });
        navMessage = findViewById(R.id.navMessage);
        navMessage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(ExploreMenuClient.this, MessagesMenu.class));
            }
        });
        navJob = findViewById(R.id.navJob);
        navJob.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(ExploreMenuClient.this, DashboardClient.class));
            }
        });
        navNotif = findViewById(R.id.navNotif);
        navNotif.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(ExploreMenuClient.this, Notifications.class));
            }
        });
        navProfile = findViewById(R.id.navProfile);
        navProfile.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(ExploreMenuClient.this, Profile.class));
            }
        });
    }
